 ...
 */
@WebServlet("/SpecialDealApi")
public class SpecialDealApi extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  	  ...
  	  if (conn != null) {
		  ...
		  String sql3 = "select distinct acity as city from flight union select distinct dcity as city from flight";
		  st = conn.createStatement();
